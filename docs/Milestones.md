...
| 2 Security control plane | Implemented candidate | identity/RBAC+ABAC/mTLS/signing/replay/secrets/crypto/audit | M2 local+distributed positive/negative security suite |
| 3 Supply chain | Planned | SBOM/AI BOM/locks/provenance/VEX | signed promotion gate |
| 4 AI security | Planned | model/data/RAG/evals/threat model | AI security/eval gate |
| 5 Risk/compliance automation | Planned | impact/privacy/providers/exceptions | governance completeness gate |
